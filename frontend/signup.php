...
<body>
    <div class="contenedor">
        ...
        <div class="contenido-login">
            ...
            <form action="../backend/signup.php" method="POST" role="form" onsubmit="return validarContraseña();">
                <h3>Registro</h3>
                <?php
                if (isset($errMsg)) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-div">
                            <div class="div">
                                <input type="text" name="ID" value="<?php if (isset($_POST['ID'])) {
                                    echo $_POST['ID'];
                                } ?>" autocomplete="off"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-div">
                            <div class="div">
                                <input type="password" id="pass" name="password" value="<?php if (isset($_POST['password'])) {
                                    echo $_POST['password'];
                                } ?>"
                        ...
                        <div class="input-div">
                            <div class="div">
                                <input type="password" id="conf_pass" name="conf_password" value="<?php if (isset($_POST['conf_password'])) {
                                    echo $_POST['conf_password'];
                                } ?>"
                                    autocomplete="off" placeholder="Confirmar contraseña">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-div">
                            <div class="div">
                                <input type="text" name="phone_num" value="<?php if (isset($_POST['phone_num'])) {
                        ...
                        <div class="input-div">
                            <div class="div">
                                <input type="date" name="fechaNac" value="<?php if (isset($_POST['fechaNac'])) {echo $_POST['phone_num'];}?>">
                            </div>
                        </div>
                    </div>
