<div class="modal fade" id="editMed<?php echo $medico['ID_Usu']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" id="userName" name="userName" class="form-control"
                                value="<?php echo $medico['User_Name']; ?>" require="">
                        </div>

                        <div class="col-6 mb-3">
                            <label for="fechanac" class="form-label">Fecha de nacimiento</label>
                            <input type="date" id="fechaNac" name="fechaNac" class="form-control"
                                value="<?php echo $medico['FechaNac']; ?>" require="">
                        </div>

                        <div class="col-6 mb-3">
                            <label for="tel" class="form-label">Teléfono</label>
                            <input type="text" id="tel" name="tel" class="form-control"
                                value="<?php echo $medico['Telefono']; ?>" require="">
                        </div>

                        <div class="col-6 mb-3">
                            <label for="Esp" class="form-label">Especialidad</label>
                            <select class="form-select" aria-label="Default select example" name="Esp" required>
                                <option selected>Seleccionar</option>
                                <?php 
                                foreach ($listEsp as $especialidad) {?>
                                <option value="<?php echo $especialidad['id_esp']; ?>"><?php echo $especialidad['descripcion']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <input type="hidden" name="id" value="<?php echo $medico['ID_Usu']; ?>">
                        <br>
                    </div>
...
<script>
    document.getElementById('editMed').addEventListener('submit', function(event) {
