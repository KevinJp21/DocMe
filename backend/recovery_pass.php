...
if (isset($_POST['recovery'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($user = $stmt->fetch()) {
            ...
            $body = 'Hola ' . ', Para recuperar tu contraseña de DocMe haz clic en el siguiente enlace:
            ' . 'http://localhost/DocMe/frontend/change_pass.php?token=' . $token . '

        Este enlace caducará en 24 horas.

        Si no has solicitado una recuperación de contraseña, ignora este correo electrónico.
